/* cookie-consent.js — Banner RGPD para Google Analytics (GA4)
   Soluções Diferentes | www.solucoesdiferentes.pt

   Uso: adicionar em cada página antes de </body>:
   <script src="cookie-consent.js"></script>

   NOTA: o Google Analytics (GA4) foi removido deste site — não está
   configurado nenhum ID de analítica de terceiros. Este ficheiro mostra
   apenas o banner de consentimento (RGPD) e fica pronto para o Consent
   Mode v2 assim que a Soluções Diferentes criar a sua própria propriedade
   GA4 e adicionar o bloco de código correspondente no <head> de cada página:
   ...
   Até lá, o botão "Aceitar" apenas grava o consentimento em localStorage
   e chama gtag(...) de forma defensiva (sem efeito, pois o gtag.js não
   está carregado) — não há qualquer envio de dados a terceiros.
*/
(function() {
